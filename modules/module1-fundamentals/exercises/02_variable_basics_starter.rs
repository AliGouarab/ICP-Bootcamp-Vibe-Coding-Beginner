fn main() {
    ...
    let sum = my_integer as f64 + my_float;      // Convert integer to float for addition
    ...
    println!("Original float value: 5.5"); // original before modification
